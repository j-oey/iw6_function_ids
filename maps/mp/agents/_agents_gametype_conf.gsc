...
_ID28940()
{
    level._ID2507["squadmate"]["gametype_update"] = ::_ID36673;
    level._ID2507["player"]["think"] = ::_ID36669;
}

_ID36669()
{
    thread maps\mp\bots\_bots_gametype_conf::_ID36830();
}
...
_ID36673()
{
    ...
    if ( gettime() > self._ID37732 )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_2 = self.owner maps\mp\bots\_bots_gametype_conf::_ID36843( 1, var_1, var_0 );
