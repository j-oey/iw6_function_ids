...
initializematchrules()
{
    ...
    maps\mp\_utility::_ID25714( "sotf_ffa", 1 );
    setdynamicdvar( "scr_sotf_ffa_winlimit", 1 );
    maps\mp\_utility::_ID25724( "sotf_ffa", 1 );
    setdynamicdvar( "scr_sotf_ffa_halftime", 0 );
    maps\mp\_utility::_ID25706( "sotf_ffa", 0 );
...
_ID22905()
{
    ...
    maps\mp\_utility::_ID28804( "allies", var_0 );
    maps\mp\_utility::_ID28804( "axis", var_0 );

    if ( level.splitscreen )
    {
        maps\mp\_utility::_ID28803( "allies", var_0 );
        maps\mp\_utility::_ID28803( "axis", var_0 );
    }
    else
    {
        maps\mp\_utility::_ID28803( "allies", var_1 );
        maps\mp\_utility::_ID28803( "axis", var_1 );
    }
