...
initializematchrules()
{
    ...
    maps\mp\_utility::_ID25714( "sr", 0 );
    setdynamicdvar( "scr_sr_scorelimit", 1 );
    maps\mp\_utility::_ID25717( "sr", 1 );
    setdynamicdvar( "scr_sr_halftime", 0 );
    maps\mp\_utility::_ID25706( "sr", 0 );
...
getspawnpoint()
{
    ...
    {
        var_1 = maps\mp\gametypes\_spawnlogic::_ID15350( "mp_sd_spawn_" + var_0 );
        var_2 = maps\mp\gametypes\_spawnlogic::_ID15349( var_1 );
    }
    else
    {
        var_1 = maps\mp\gametypes\_spawnlogic::_ID15425( var_0 );
        var_2 = maps\mp\gametypes\_spawnscoring::_ID15348( var_1 );
    }
...
_ID22882()
{
    for (;;)
    {
        ...
        level notify( "sr_player_disconnected",  var_0  );
    }
}

_ID38028( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    if ( isdefined( self._ID32285 ) )
        return 0;

    if ( isdefined( self._ID35916 ) )
        return 0;
...
_ID22886( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( !maps\mp\_utility::_ID14065( "prematch_done" ) )
        maps\mp\gametypes\_playerlogic::_ID20776();
    else
    {
        var_10 = _ID38028( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 );

        if ( var_10 )
            var_10 = var_10 && !maps\mp\_utility::_ID18757( self );

        if ( var_10 )
            var_10 = var_10 && !maps\mp\gametypes\_playerlogic::_ID20776();

        if ( var_10 )
            level thread _ID30824( self, var_1 );
    }
...
_ID30824( var_0, var_1 )
{
    ...
    var_2 = maps\mp\_utility::getotherteam( var_0.team );
    var_3 = var_0.origin + ( 0, 0, 14 );
    ...
    else
    {
        ...
        var_4[0] setclientowner( var_0 );
        var_4[0] setmodel( "prop_dogtags_foe_iw6" );
        var_4[1] = spawn( "script_model", ( 0, 0, 0 ) );
        var_4[1] setclientowner( var_0 );
        var_4[1] setmodel( "prop_dogtags_friend_iw6" );
        var_5 = spawn( "trigger_radius", ( 0, 0, 0 ), 0, 32, 32 );
        level.dogtags[var_0._ID15851] = maps\mp\gametypes\_gameobjects::_ID8493( "any", var_5, var_4, ( 0, 0, 16 ) );
        ...
        level.dogtags[var_0._ID15851].victimteam = var_0.team;
        level thread clearonvictimdisconnect( var_0 );
        var_0 thread _ID32370( level.dogtags[var_0._ID15851] );
    }

    level.dogtags[var_0._ID15851].curorigin = var_3;
    level.dogtags[var_0._ID15851].trigger.origin = var_3;
    level.dogtags[var_0._ID15851]._ID35361[0].origin = var_3;
    level.dogtags[var_0._ID15851]._ID35361[1].origin = var_3;
    ...
    level.dogtags[var_0._ID15851]._ID35361[0] thread _ID29994( level.dogtags[var_0._ID15851], maps\mp\_utility::getotherteam( var_0.team ) );
    level.dogtags[var_0._ID15851]._ID35361[1] thread _ID29994( level.dogtags[var_0._ID15851], var_0.team );
    level.dogtags[var_0._ID15851].attacker = var_1;
    objective_icon( level.dogtags[var_0._ID15851]._ID32670[var_0.team], "waypoint_dogtags_friendlys" );
    objective_position( level.dogtags[var_0._ID15851]._ID32670[var_0.team], var_3 );
    objective_state( level.dogtags[var_0._ID15851]._ID32670[var_0.team], "active" );
    objective_team( level.dogtags[var_0._ID15851]._ID32670[var_0.team], var_0.team );
    objective_icon( level.dogtags[var_0._ID15851]._ID32670[var_2], "waypoint_dogtags" );
    objective_position( level.dogtags[var_0._ID15851]._ID32670[var_2], var_3 );
    objective_state( level.dogtags[var_0._ID15851]._ID32670[var_2], "active" );
    objective_team( level.dogtags[var_0._ID15851]._ID32670[var_2], var_2 );
...
_ID31142( var_0, var_1, var_2 )
{
    foreach ( var_4 in level.players )
    {
        if ( isdefined( var_1 ) && var_4.team != var_1 )
            continue;

        if ( isdefined( var_2 ) && var_4 == var_2 )
            continue;

        var_4 thread maps\mp\gametypes\_hud_message::_ID31052( var_0 );
    }
}

_ID31140( var_0, var_1, var_2 )
{
    var_3 = var_2.team;
    ...
    foreach ( var_6 in level.players )
    {
        ...
        {
            if ( var_6 != var_2 )
                var_6 _ID31139( var_0 );

            continue;
        }

        if ( var_6.team == var_4 )
            var_6 _ID31139( var_1 );
    }
}

_ID31139( var_0 )
{
    thread maps\mp\gametypes\_hud_message::_ID31052( var_0 );
}
...
_ID22916( var_0 )
{
    ...
    if ( var_0.pers["team"] == self.victimteam )
    {
        ...
        var_0.pers["rescues"]++;
        var_0 maps\mp\gametypes\_persistence::_ID31528( "round", "rescues", var_0.pers["rescues"] );
        var_0 maps\mp\_utility::setextrascore0( var_0.pers["denied"] );
        ...
        if ( isdefined( self._ID35229 ) )
        {
            self._ID35229 thread maps\mp\gametypes\_hud_message::_ID31052( "sr_respawned" );
            level notify( "sr_player_respawned",  self._ID35229  );
            self._ID35229 maps\mp\_utility::_ID19765( "revived" );
        }

        _ID31140( "sr_ally_respawned", "sr_enemy_respawned", self._ID35229 );

        if ( isdefined( self._ID35229 ) )
        {
            if ( !level.gameended )
                self._ID35229 thread _ID31141();
        }

        if ( isdefined( self.attacker ) )
            self.attacker thread maps\mp\gametypes\_rank::_ID36462( "kill_denied" );

        var_0 thread _ID22909( var_1 );
        var_0 maps\mp\gametypes\_missions::_ID25038( "ch_rescuer" );

        if ( !isdefined( var_0._ID37892 ) )
            var_0._ID37892 = [];

        var_0._ID37892[self._ID35229._ID15851] = 1;

        if ( var_0._ID37892.size == 4 )
            var_0 maps\mp\gametypes\_missions::_ID25038( "ch_helpme" );
    }
    else
    {
        ...
        if ( isdefined( self._ID35229 ) )
        {
            self._ID35229 thread maps\mp\gametypes\_hud_message::_ID31052( "sr_eliminated" );
            level notify( "sr_player_eliminated",  self._ID35229  );
        }

        _ID31140( "sr_ally_eliminated", "sr_enemy_eliminated", self._ID35229 );

        if ( isdefined( self._ID35229 ) )
        {
            if ( !level.gameended )
            {
                self._ID35229 maps\mp\_utility::setlowermessage( "spawn_info", game["strings"]["spawn_next_round"] );
                self._ID35229 thread maps\mp\gametypes\_playerlogic::_ID26032( 3.0 );
            }

            self._ID35229._ID32355 = undefined;
            self._ID35229.extrascore1 = 2;
        }

        if ( self.attacker != var_0 )
            self.attacker thread _ID22909( var_1 );

        var_0 _ID22909( var_1 );
        var_0 maps\mp\_utility::_ID19765( "kill_confirmed" );
        var_0 maps\mp\gametypes\_missions::_ID25038( "ch_hideandseek" );
    }
...
_ID26142()
{
    ...
    objective_state( self._ID32670[self.victimteam], "invisible" );
    objective_state( self._ID32670[maps\mp\_utility::getotherteam( self.victimteam )], "invisible" );
}
...
clearonvictimdisconnect( var_0 )
{
    ...
    if ( isdefined( level.dogtags[var_1] ) )
    {
        ...
        if ( isdefined( level.dogtags[var_1] ) )
        {
            objective_delete( level.dogtags[var_1]._ID32670["allies"] );
            objective_delete( level.dogtags[var_1]._ID32670["axis"] );
