...
_ID36982( var_0, var_1, var_2 )
{
    ...
    for ( var_16 += var_18; var_16 < var_7; var_16 += var_17 )
    {
        var_20 = [];

        foreach ( var_22 in level.agentarray )
        {
            if ( isdefined( var_22 ) && isalive( var_22 ) && var_22 istouching( var_15 ) && !isdefined( var_22._ID37683 ) )
        ...
        foreach ( var_22 in var_20 )
        {
            ...
            {
                var_22 thread _ID36981( var_6, var_0, var_8, var_15, var_9, var_2 );
