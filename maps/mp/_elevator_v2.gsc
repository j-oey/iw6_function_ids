...
_ID17730( var_0 )
{
    ...
    if ( isdefined( var_0._ID10745 ) )
    {
        ...
        if ( isdefined( var_0._ID10744 ) )
            var_1._ID10744 = var_0._ID10744;
        else
            var_1._ID10744 = 2;

        var_1.doorspeed = var_0._ID10741 / var_1._ID10744;

        if ( isdefined( var_0._ID4533 ) )
            var_1._ID4533 = var_0._ID4533;
        else
            var_1._ID4533 = 10;
    ...
    if ( isdefined( var_0._ID21687 ) )
        var_1._ID21687 = var_0._ID21687;
    else
        var_1._ID21687 = 5;
    ...
    var_12 = common_scripts\utility::_ID15386( var_0.destinations, "targetname" );

    foreach ( var_14 in var_12 )
        var_1 setupdestination( var_14 );

    var_1.destinationnames = var_0.destinationnames;
    var_1._ID8605 = var_0.destinationnames[0];
...
setupdestination( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        self.destinations[var_0._ID27658] = var_0.origin;
        ...
        if ( isdefined( var_0.target ) )
        {
            ...
            if ( isdefined( var_1 ) )
                self.pathblockers[var_0._ID27658] = var_1;
        }
    }
}
...
buttonthink()
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( self._ID27658 ) || self._ID27658 == "elevator" )
        {
            if ( var_0._ID8605 == var_0.destinationnames[0] )
                var_0._ID26060 = var_0.destinationnames[1];
            else
                var_0._ID26060 = var_0.destinationnames[0];
        }
        else
...
_ID11327()
{
    var_0 = self._ID10745.size > 0;

    for (;;)
    {
        self waittill( "elevator_called" );

        foreach ( var_2 in self._ID6359 )
            var_2 disablebutton();
        ...
        if ( self._ID8605 != self._ID26060 )
        {
            if ( self._ID10750 != 0 )
            {
                ...
                elevatorblockpath( self._ID8605 );
        ...
        if ( var_0 )
        {
            ...
            elevatorclearpath( self._ID8605 );
...
elevatormovetofloor( var_0 )
{
    ...
    if ( isdefined( self._ID10745["elevator"] ) )
    {
    ...
    if ( isdefined( self.onarrivedcallback ) )
        self thread [[ self.onarrivedcallback ]]( self._ID8605 );
}
