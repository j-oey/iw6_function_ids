...
_ID29184( var_0 )
{
    ...
    if ( vectordot( var_5, var_7 ) > 0 )
    {
        ...
        {
            var_10 = _ID34932( var_6, vectordot( var_5, var_6 ) );
            var_8 = var_4 - var_10;
            var_9 = var_3 + var_10;
        }
    }
    ...
    if ( var_1 > 0 )
    {
        ...
        {
            var_14 = var_1 / var_13;
            var_15 = _ID34932( var_7, var_12 * ( var_14 - 1 ) * 0.5 );
        }
        else
        {
            var_14 = var_13 / var_1;
            var_15 = _ID34932( var_6, var_11 * ( var_14 - 1 ) * 0.5 );
        }
    ...
    level._ID20638 = vectordot( var_8 - var_9, var_6 );
